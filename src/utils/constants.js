...
export const formDataProfileEdit =
  popupProfileEdit.querySelector(".form__data");
...
export const buttonOpenPopupProfileEdit = profileSection.querySelector(
  ".profile__button-edit"
);
export const buttonOpenPopupNewPlace = profileSection.querySelector(
  ".profile__button-add"
);
export const buttonOpenPopupAvatar =
  profileSection.querySelector(".profile__overlay");

// инпуты формы
export const inputNameFormProfileEdit = document.querySelector(
  ".form__input_js_name"
);
export const inputJobFormProfileEdit = document.querySelector(
  ".form__input_js_job"
);
